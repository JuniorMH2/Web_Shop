                        ...
                        <section class="swiper-slide">
                            <div class="home__content grid">
                                ...
                                <div class="home__data">
                                    <h3 class="home__subtitle">#1 Diseño y Desarrollo Web</h3>
                                    ...
                                    <p class="home__description">
                                        Adelante, el curso además de enseñarte de forma práctica y real, pero también puedes vender los proyectos.
                        ...
                        <section class="swiper-slide">
                            <div class="home__content grid">
                                ...
                                <div class="home__data">
                                    ...
                                    <p class="home__description">
                                        En este curso de SQL y de Modelado de Base de Datos SQL Server conocerás las reglas que debes considerar durante el proceso de modelado y diseño de base de datos.
                                    </p>
                        ...
                        <section class="swiper-slide">
                            <div class="home__content grid">
                                ...
                                <div class="home__data">
                                    ...
                                    <p class="home__description">
                                        En este curso te formarás por completo en el lenguaje Visual Basic .NET para desarrollar aplicaciones, en acceso a bases de datos con la tecnología ADO.NET, en acceso a datos almacenados en diversos gestores de BBDD y en el manejo de formularios Windows.
                ...
                <div class="about__container container grid">
                    <div class="about__data">
                        ...
                        <p class="about__description">
                            Somos un Instituto de Educación Superior Público,
                            con prestigio vigente durante nuestros 75 años de
                            impartir enseñanza de calidad y mantener un compromiso
                            con el País. Nuestra mejor carta de presentación
                            son nuestros egresados. Contamos con un excelente
                            equipo docente, herramientas y equipos acordes con
                            los avances de la tecnología y renovada infraestructura.
                        </p>
                        <a href="http://www.istpargentina.edu.pe/docentes-nosotros/" target="_blank" class="button"> Saber más</a>
                    </div>
            ...
            <div class="footer__container container grid">
                <div class="footer__content">
                    ...
                    <p class="footer__description">
                        ...
                        Horario de Atención - Oficinas: <br />
